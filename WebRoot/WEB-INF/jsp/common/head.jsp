...
<!--时间-->
 ...
 <section class="publicMian ">
     <div class="left">
         ...
         <nav>
             <ul class="list">
                 <li ><a href="${pageContext.request.contextPath }/clothing/saveClothing.html">添加衣服</a></li>
              <li><a href="${pageContext.request.contextPath }/clothing//addImg.html">添加图片</a></li>
              <li><a href="${pageContext.request.contextPath }/clothing/index.html" target="_blank">店铺首页</a></li>
